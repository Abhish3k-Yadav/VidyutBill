...
public class MeterInfo extends JFrame implements ActionListener{
    ...
    MeterInfo(String meternumber) {
        ...
        JPanel p = new JPanel();
        p.setLayout(null);
        p.setBackground(new Color(140, 240, 70));
        add(p);
        ...
        JLabel dis  = new JLabel("\"Power the future with green energy—because a sustainable planet is the brightest legacy we can leave.\"");
        dis.setBounds(900, 900, 1500, 20);
        dis.setFont(new Font("Roboto", Font.BOLD, 14));
        ImageIcon icon1 = new ImageIcon(ClassLoader.getSystemResource("icon/icon14.png"));
        Image image1 = icon1.getImage().getScaledInstance(20, 20, Image.SCALE_DEFAULT);
        dis.setIcon(new ImageIcon(image1));
        p.add(dis);
